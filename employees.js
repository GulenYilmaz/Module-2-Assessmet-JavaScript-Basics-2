...
//CODE HERE
 var empOne = new Employee("Anna","night from 7pm to 12am");
...
class Manager extends Employee {
    ...
    constructor(name,shifts,contact){
super(name,shifts);
this.console=contact;

    }
    getEmployees(){
        console.log(`${this.name} manages ${this.contact}`)
    }
...
//CODE HERE
 var manager =new Manager("Greg","morning shift","2483765596")
